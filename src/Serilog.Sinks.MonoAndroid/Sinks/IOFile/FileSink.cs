    ...
    public sealed class FileSink : ILogEventSink, IDisposable
    {
        ...
        public void Emit(LogEvent logEvent)
        {
            ...
            lock (_syncRoot)
            {
                ...
                //// Needed to make file visible from Windows Explorer (at least over USB connection)
                //// But should probably be done after flush is completely finished, otherwise only
                //// partially content will be visible (surprisingly, in this case, Windows Explorer
                //// file preview may reveal full content when only partial is visible in a text editor like Notepad).
                //Android.Media.MediaScannerConnection.ScanFile(
                //    Android.App.Application.Context,
                //    new String[] { _filePath },
                //    null,
                //    null);
            }
        }
